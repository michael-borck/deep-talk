...
- **Next backlog:**
  - Upload-then-assign-project flow (currently you have to pick the project before uploading)
  - Bulk operations (export many, batch tag, select all in Library)
  - STT confidence display
  - Original/corrected/speaker-tagged diff view
